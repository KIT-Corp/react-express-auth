...
import "./signup-form.css"; // Make sure this import is here
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
...
export function SignupForm({ className, ...props }) {
  ...
  return (
    <div
      ...
      {...props}
    >
      <Card className="signup-card p-0 md:w-[700px] w-full max-w-xl">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                ...
                />
                {errors.zipcode && (
                  <p className="signup-error">{errors.zipcode}</p>
                )}
              </div>
              ...
              {errors.submit && <p className="signup-error">{errors.submit}</p>}
